...
INSERT INTO `admin_users` (`user_id`,`chapter_id`)
VALUES
  (1, 1)
...
INSERT INTO `client_users` (`user_id`, `name`,`email`,`phone`,`password`,`role_id`,`verified`, `oauth`, `alert_case_id`)
VALUES
(1, "Abby C", "abby2@gmail.com", "905456", "password2", 0, TRUE, FALSE, 1), 
(2, "Sarah F", "sarah@outlook.com", "416123", "password3", 1, TRUE, FALSE, 2), 
(3, "Alex P", "alexp@outlook.com", "416416", "password4", 2, TRUE, FALSE, 3);
