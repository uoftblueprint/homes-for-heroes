...
const QuestionTypeAnswerCompleted = function (question) {
    let inputValue = question.value;
    const types = [
        {
            qType: 1,
            name: "Short Answer",
        ...
        },
        {
            ...
            viewProps: { 
                ...
                onBlur: () => {question.value = inputValue},
                renderInput: (params) => {params.inputProps.value = question.value ? question.value : 'yyyy-mm-dd hh:mm'; return <TextField disabled {...params} />}
            },
        },
    ]
...
export default QuestionTypeAnswerCompleted;