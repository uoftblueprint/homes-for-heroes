...
function loadServerRows(searchParams, page, pageSize) {
  return new Promise((resolve) => {
    let url = "http://localhost:3000/api/supporters";
    ...
    fetch(url, {
      ...
      .then((resp) => resp.json())
      .then((resp) => {
        if (resp.supporters.constructor === Array){
          resolve(resp.supporters);
        }
        {
          resolve([])
        }
...
export default function CRM() {
  ...
  return (
    ...
    <Grid
      ...
      <AddSupporterModal dialog={dialog} toggleDialog={toggleDialog} />
    </Card>
  );
}
